...
[CreateAssetMenu(fileName = "TestPassiveSkill", menuName = "ScriptableObjects/SkillTree/Test/PassiveSkill")]
public class TestPassiveSkill : PassiveSkillData
{
    [SerializeField] private int bonusAttackPower;
    [SerializeField] private int bonusHp;
    [SerializeField] private float bonusCriticalPercentage;
